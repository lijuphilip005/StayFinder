...
const NavBar = () => {
  ...
  return (
    <>
      <nav
        className={` max-w-7xl fixed top-0 left-0 right-0 z-10 bg-white  flex justify-between items-center mx-auto  h-20 ${
        ...
        <div className="inline-flex ">
          <a className="_o6689fn" href="/">
            <div className="hidden md:block">
              ...
              <svg width={102} height={32} fill="currentcolor" style={{ display: "block" }}></svg>
            </div>
            <div className="block md:hidden">
              <svg width={30} height={32} fill="currentcolor" style={{ display: "block" }}></svg>
            </div>
          </a>
        </div>
        {/* end logo */}
          ...
          <div className="flex justify-end items-center relative">
            <div className="flex mr-4 items-center">
              <a className="inline-block py-2 px-3 hover:bg-gray-200 rounded-full" href="#">
                <div
                  className={`flex items-center relative cursor-pointer whitespace-nowrap ${location.pathname === "/admin/home" ? "hidden" : "flex"}`}
                >
                  Become a host
                </div>
              </a>
